						...
						<table class="display" id="myTable">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$supplier->name}}</td>
									<td class="text-success">{{time2str2($supplier->time)}}</td>
									<td @if($supplier->status == 'Activated') class="text-success" @else class="text-danger" @endif>{{$supplier->status}}</td>
									<td><!-- Icon Dropdown -->
										<div class="btn-group">
										  ...
										  <ul class="dropdown-menu">
											<form @if($supplier->status == 'Activated') action="/deactivate" @else action="/activate" @endif  method="POST">
												@csrf
